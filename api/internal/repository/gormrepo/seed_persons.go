...
func (r *PersonRepository) SeedDummyPersons(ctx context.Context) error {
	dummyPersons := []PersonModel{
		{
			UUID: "b3b1c7e2-8c2a-4e2a-9c1a-2b1c7e28c2a4", Emoji: "😀", Sign: "A", RegisterUUID: "a1a2b3c4-d5e6-7f89-0abc-def123456789", SightedCount: 5, SightingTime: "12:00",
			X: 139.6917, Y: 35.6895, Gender: "男性", Clothing: "スーツ", Accessories: "帽子", Vehicle: "自転車", Behavior: "徘徊", Hairstyle: "短髪",
		},
		{
			UUID: "c2d3e4f5-6789-4abc-8def-1234567890ab", Emoji: "😁", Sign: "あ", RegisterUUID: "a1a2b3c4-d5e6-7f89-0abc-def123456789", SightedCount: 3, SightingTime: "12:30",
			X: 135.5023, Y: 34.6937, Gender: "女性", Clothing: "私服", Accessories: "眼鏡", Vehicle: "徒歩", Behavior: "つきまとい", Hairstyle: "長髪",
		},
		{
			UUID: "d4e5f6a7-8901-4bcd-9efa-2345678901bc", Emoji: "😂", Sign: "東", RegisterUUID: "a1a2b3c4-d5e6-7f89-0abc-def123456789", SightedCount: 8, SightingTime: "13:00",
